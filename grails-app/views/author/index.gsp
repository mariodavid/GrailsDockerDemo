		...
		<div id="list-author" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="geburtstag" title="${message(code: 'author.geburtstag.label', default: 'Geburtstag')}" />
					
						<g:sortableColumn property="name" title="${message(code: 'author.name.label', default: 'Name')}" />
					
						<g:sortableColumn property="vorname" title="${message(code: 'author.vorname.label', default: 'Vorname')}" />
				...
				<g:each in="${authorInstanceList}" status="i" var="authorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${authorInstance.id}">${fieldValue(bean: authorInstance, field: "geburtstag")}</g:link></td>
					
						<td>${fieldValue(bean: authorInstance, field: "name")}</td>
					
						<td>${fieldValue(bean: authorInstance, field: "vorname")}</td>
