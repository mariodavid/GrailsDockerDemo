	...
	<body>
		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<g:if test="${bookInstance?.anzahlSeiten}">
				<li class="fieldcontain">
					<span id="anzahlSeiten-label" class="property-label"><g:message code="book.anzahlSeiten.label" default="Anzahl Seiten" /></span>
					
						<span class="property-value" aria-labelledby="anzahlSeiten-label"><g:fieldValue bean="${bookInstance}" field="anzahlSeiten"/></span>
